...
<body>
  ...
  <section id = "main" class = "homeContent">
    <div id = "banner">
      <div class = "mainLeft">
        <h1>Make Learning Exciting</h1>
        <p>Sub Zero + You = Amazing Education</p>
        <button class = "primary-action" onclick = "window.location.href='index.php'">Request Information</button>
      </div>
      <div class = "mainRight">
  ...
  <section id = "video">
    <div id = "videoLeft">
      <iframe width="1280" height="720" src="https://www.youtube.com/embed/pDyA3RVeKiA?modestbranding=1&?rel=0&?mute=1" title="Stem School V3" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
